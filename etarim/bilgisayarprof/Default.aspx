<%@ Page Title="" Language="C#" MasterPageFile="~/bilgisayarprof/bilgisayarprof.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="bilgisayarprof_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <table width="748" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="254" align="left" valign="top" style="padding-top:21px; padding-bottom:28px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="top" style="padding-bottom:28px;" class="style2"><table width="254" border="0" cellspacing="0" cellpadding="0" style="border:#2A7D77 1px solid;">
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#3B9C9C;">
                    <tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <td width="526" align="left" valign="top" style="padding-top:21px; padding-bottom:28px;"><table width="480" border="0" align="right" cellpadding="0" cellspacing="0" style=" border:#414141 1px solid;">
          <tr>
            <td align="left" valign="top" style="background-color:#80CDCE;">
                <table 
                    border="0" cellspacing="0" cellpadding="0" 
                    style="height: 502px; width: 45%;">
                <tr>
...
normal"> </span></p>
       ...
       <asp:LinkButton ID="LinkButton3" runat="server" Font-Size="Medium" 
                        ForeColor="Black" onclick="mevzuatlar_Click">Eklenen tüm dosyalar için tıklayınız.</asp:LinkButton><br /><br />
          </td>
      </tr>
