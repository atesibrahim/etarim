...
public partial class ciftci_mesaj_gonder : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataRow drciftci2 = veri.GetDataRow("select * from ciftci where kod=" + adminid);
        ...
        else
        {
            ...
            DataRow drciftci = veri.GetDataRow("select * from ciftci where kod=" + adminid);
