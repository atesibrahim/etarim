...
public partial class ciftci_profilim : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataRow ciftciDB = veritabani.GetDataRow("select * from ciftci where kod = '" + kod2 + "'");
                ...
                LabelAd.Text = ciftciDB["ad"].ToString();
                LabelSoyad.Text = ciftciDB["soyad"].ToString();
                TextBox1.Text = ciftciDB["adres"].ToString();
                LabelCepTel.Text = ciftciDB["cep_tel"].ToString();
                LabelEvTel.Text = ciftciDB["ev_tel"].ToString();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (TextBoxEmail.Text == "")
            {
                ...
                {
                    DataRow ciftci = veritabani.GetDataRow("UPDATE  ciftci SET ad='" + TextBoxAd.Text + "', soyad='" + TextBoxSoyad.Text + "', cep_tel='" + TextBoxCepTel.Text + "', ev_tel='" + TextBoxEvTel.Text + "', adres='" + TextBoxAdres.Text + "', adres_il='" + adresilkodu + "', adres_ilce='" + adresilcekodu + "' where kod = '" + kod3 + "'");
                    ...
                    Response.Redirect("~/ciftci/profilim.aspx");
                }
