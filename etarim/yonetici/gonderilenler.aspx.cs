...
public partial class yonetici_gonderilenler : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        SqlCommand Cmd = new SqlCommand("SELECT kime, tarih , konu,id FROM mesaj_gonderilen WHERE  kimden='" + kimden + "' or kimden='SİSTEM YÖNETİCİSİ' order by id DESC ", Conn);
    ...
    protected void select(object sender, ImageClickEventArgs e)
    {
        ...
        Label3.Text ="KONU:"+ mesaji["konu"].ToString();
