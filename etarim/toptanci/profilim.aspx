<%@ Page Title="" Language="C#" MasterPageFile="~/toptanci/toptanci.master" AutoEventWireup="true" CodeFile="profilim.aspx.cs" Inherits="toptanci_profilim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="Medium" 
                            Text="Profil Görüntüle-Düzenle Sayfası"></asp:Label>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
    ...
    <table align="center" class="style1">
        ...
        <tr>
            ...
            <td class="style18" id="labelSoyad0">
        ...
        <tr>
            <td class="style24">
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label8" runat="server" Text="İş Tel :"></asp:Label>
                <br />
            </td>
            <td class="style25">
            ...
            <td class="style3">
                ...
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxCepTel"
                ...
                <br />
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBoxEvTel"
                    ErrorMessage="Lütfen geçerli bir telefon numarası giriniz. Örnek: 0212 111 1111"
                    ValidationGroup="RegisterValidation"
                    ValidationExpression="(\\d{4}\\d{3}\d{4})|(\d{11})">
        ...
        <tr>
            ...
            <td class="style6">
                <asp:TextBox ID="TextBox1" runat="server" Enabled="False" Height="83px" 
                    style="margin-left: 0px" TextMode="MultiLine" Width="150px"></asp:TextBox>
                <br />
                <br />
