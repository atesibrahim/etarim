<%@ Page Title="" Language="C#" MasterPageFile="~/toptanci/toptanci.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="toptanci_Default" %>
...
normal"> </span></p>
       ...
       <asp:LinkButton ID="LinkButton3" runat="server" Font-Size="Medium" 
                        ForeColor="Black" onclick="mevzuatlar_Click">Yararlı dosyalar için tıklayınız.</asp:LinkButton><br />
          </td>
      </tr>
