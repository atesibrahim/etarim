...
public partial class toptanci_gelen_kutusu : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        SqlCommand Cmd = new SqlCommand("SELECT kimden, tarih , konu,okundu,id FROM mesajlar WHERE  kime='" + kime + "' order by okundu, tarih DESC  ", Conn);
    ...
    protected void select(object sender, ImageClickEventArgs e)
    {
        ...
        Label2.Text =  mesaji["konu"].ToString();
